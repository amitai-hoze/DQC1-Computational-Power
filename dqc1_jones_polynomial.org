...
<<imports>>
<<beside-operators>>
knot pts = cubicSpline True pts # center
pts = map p2 [(0,0), (1,1), (0,1), (1,0)]
splineEnvelope = withEnvelope (cubicSpline True pts :: D R2)
equivalent = arrowBetween' (with & arrowHead .~ dart & arrowTail .~ dart') (p2 (0,0)) (p2 (1,0))
space = square 0.2 # opacity 0
--main = mainWith (dia)
--dia :: Diagram B R2
dia = knot pts --> space --> equivalent --> space --> circle 0.7
#+end_src
:image:
...
closeTrace i mfpath = p2 (6 - i,5).--.mfpath
main = mainWith (dia)
dia :: Diagram B R2
space n = square n # opacity 0
colors = cycle [aqua, orange, deeppink, blueviolet, crimson, darkgreen]
--traceClosure = metafont $ bottom 1.- tension 100 -.lowerMiddle 1.--.upperMiddle 2.- tension 100 -.top 2.--.traceClosureDistantPoint 2.--.bottom 2.- tension 100 -.lowerMiddle 2.--.upperMiddle 1.- tension 100 -.top 1.--. traceClosureDistantPoint 1 .--. cyclePath
--traceClosure = metafont $ p2 (0,0).--.cross 1 2 50.--.closeTrace 2.--.cross 2 1.--.closeTraceEnd 1
--dia = traceClosure # explodeTrail # zipWith lc colors # mconcat
using_func = metafont $ p2 (1,5).--.closeTrace 2 cyclePath
not_using_func = metafont $ p2 (1,5).--.p2 (1,10).--.p2 (4,5).--.cyclePath
i = 1
j = 2
pos = 3
dia = metafont $ (cross 1 2 5 (closeTrace 2 (cross 2 1 5 (closeTrace 1 cyclePath))))
#+end_src
