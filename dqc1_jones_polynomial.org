...
** Simple unknot                                                    :ATTACH:
:PROPERTIES:
:Attachments: simple%20unknot_1.jpg simple%20unknot_2.jpg simple%20unknot_3.jpg simple%20unknot_4.jpg simple%20unknot_5.jpg
...
[[file:data/a8/0e6450-c92f-49a0-b07f-f42473ddd5ad/simple unknot_1.jpg]]
...
simple_unknot_2 = ">1<2<3<1>2>3>1"

separate_ops :: [Char] -> [[Char]]
separate_ops exp = tail (split (oneOf "<>") exp)

sep = separate_ops simple_unknot_2

simplify :: [[Char]] -> [[Char]]
simplify [] = []
--simplify ["<", a, "<", b] = ["<", a++b]
simplify (">":a:">":b:tail) = [">",a++b] ++ (simplify tail)
simplify ("<":a:"<":b:tail) = [">",a++b] ++ (simplify tail)
simplify (">":a:tail) = [">",a] ++ simplify(tail)
simplify ("<":a:tail) = ["<",a] ++ simplify(tail)
simplify tail = tail

main = do
     --putStrLn (concat (reduce [">1<2<3"]))
     putStrLn (concat (simplify sep))
...
[[file:haskell/images/unknot_equivalent.svg]]
