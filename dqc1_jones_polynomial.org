...
cross i j pos mfpath = bottom i.---.lowerMiddle i pos.--.upperMiddle j pos.---.top j.--.mfpath
cross i j pos = cross i j pos (endpt (top j))

closeTrace i mfpath = p2 (2 * n - i,10).--.p2 (2 * n - i,0).--.mfpath where heightOffset = (n - (i - 1))
space n = square n # opacity 0
colors = cycle [aqua, orange, deeppink, blueviolet, crimson, darkgreen]

braid = metafont $ cross 1 2 5 <> metafont cross 2 1 5. closeTrace 2 . cross 2 1 5 . closeTrace 1 $ cyclePath
