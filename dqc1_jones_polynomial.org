...
--tlTraceClosure i = metafont $ p2 (i,2).- leaving unitY <> arriving unitY -.endpt (p2 (i,0))

--traceStyle :: (HasStyle a, V a ~ R2) => a -> a
...
--text' str = text str # fontSizeL 1 # scale 0.5 <> strutR2 (r2 (2,2))
