...
unknotEquivalentColored = unknotEquivalent # explodeTrail # zipWith lc trailColors # mconcat

main = mainWith (dia)
dia :: Diagram B R2
dia = (unknotEquivalentColored # center) --> space 0.2 --> hequivalent 1--> space 0.2 --> circle 1
#+end_src
